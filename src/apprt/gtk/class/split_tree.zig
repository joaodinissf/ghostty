...
const SplitTreeSplit = extern struct {
    ...
    const Private = struct {
        ...
        /// split on the corresponding side. Both null in the common no-junction
        /// case. The widgets are owned by `overlay` once added.
    ...
    const junction_plus_epsilon: f64 = 0.005;
    ...
    fn onJunctionDragBegin(
        ...
        // currently at approximately the same perpendicular position.
        ...
        if (self.otherInnerPaned(widget)) |other| {
            ...
            if (max_extent > 0) {
                ...
                if (@abs(this_ratio - other_ratio) < junction_plus_epsilon) {
